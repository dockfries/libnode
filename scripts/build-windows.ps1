...
.PARAMETER Version
    Node.js version to build (semver, e.g. 22.23.3).
...
.EXAMPLE
    .\build-windows.ps1 -Version "22.23.3" -Arch "x64"
    .\build-windows.ps1 -Version "24.21.0" -Arch "x64" -UseClangCL
    .\build-windows.ps1 -Version "22.23.3" -Arch "x86"
#>
...
# e.g., node-v22.23.3-win-x64\libnode.dll, or in Release\ directly.
# Search for them.
$foundDll = $false
$searchPaths = @(
    "$SRC_DIR\Release",
