...
#
# Usage:  VERSION=22.23.3 ARCH=x64 ./build-linux.sh
#
...
#   VERSION   – Node.js version to build (semver, e.g. 22.23.3)
...
# ── Input validation ────────────────────────────────────────────────
VERSION="${VERSION:?Missing VERSION environment variable (e.g. 22.23.3)}"
